import { type Product, type InsertProduct, type ContactSubmission, type InsertContactSubmission } from "@shared/schema";
    ...
    const initialProducts: InsertProduct[] = [
      {
        ...
        category: "office",
        description: "Premium LED panel light perfect for modern office spaces. Delivers uniform, flicker-free illumination with exceptional energy efficiency.",
        price: 12999,
        features: [
      ...
      },
      {
        ...
        category: "industrial",
        description: "Powerful high-bay LED fixture designed for warehouses, factories, and large commercial spaces. Maximum brightness with minimum energy consumption.",
        price: 24999,
        features: [
      ...
      },
      {
        ...
        category: "outdoor",
        description: "Heavy-duty LED floodlight for outdoor applications. Weather-resistant construction ensures reliable performance in all conditions.",
        price: 18999,
        features: [
      ...
      },
      {
        ...
        category: "retail",
        description: "Elegant track-mounted spotlight ideal for retail displays and galleries. Adjustable beam angle and dimming for perfect product highlighting.",
        price: 8999,
        features: [
      ...
      },
      {
        ...
        category: "office",
        description: "Direct replacement for traditional fluorescent tubes. Plug-and-play installation with significant energy savings.",
        price: 3999,
        features: [
        ...
        specifications: "Dimensions: 1200mm length x 26mm diameter\nMaterial: Polycarbonate with aluminum PCB\nBeam Angle: 180°\nCRI: >80\nOperating Temperature: -20°C to 45°C\nCertifications: CE, RoHS, FCC",
      ...
      },
      {
        ...
        category: "office",
        description: "Smart LED downlight with wireless control capabilities. Perfect for modern smart offices and conference rooms.",
        price: 6999,
        features: [
